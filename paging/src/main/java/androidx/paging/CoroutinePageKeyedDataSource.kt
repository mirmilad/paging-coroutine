...
internal abstract class CoroutinePageKeyedDataSource<Key, Value> :
    ...
    internal class LoadInitialCallbackImpl<Key, Value>(
        dataSource: CoroutinePageKeyedDataSource<Key, Value>,
...
// after constructor, mutation must happen on UI thread.
    ...
    override fun <ToValue> mapByPage(
        ...
        return CoroutineWrapperPageKeyedDataSource(this, function)
    }
